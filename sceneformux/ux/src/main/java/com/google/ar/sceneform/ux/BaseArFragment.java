...
public abstract class BaseArFragment extends Fragment
  ...
  public View onCreateView(
    ...
    HandMotionView instructionsView = loadPlaneDiscoveryView(inflater, container);
    if (instructionsView != null) {
      if (frameLayout.findViewById(R.id.sceneform_hand_image) == null) {
  ...
  @Nullable
  private HandMotionView loadPlaneDiscoveryView(LayoutInflater inflater, @Nullable ViewGroup container) {
    return inflater.inflate(R.layout.sceneform_plane_discovery_layout, container, false)
            .findViewById(R.id.sceneform_hand_image);
  }
