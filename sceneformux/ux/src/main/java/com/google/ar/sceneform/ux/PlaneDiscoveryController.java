...
public class PlaneDiscoveryController {
  @Nullable private HandMotionView planeDiscoveryView;

  public PlaneDiscoveryController(@Nullable HandMotionView planeDiscoveryView) {
    this.planeDiscoveryView = planeDiscoveryView;
  }

  /** Set the instructions view to present over the Sceneform view. */
  public void setInstructionView(HandMotionView view) {
  ...
  public void show() {
    ...
    planeDiscoveryView.startAnimation();
  }
  ...
  public void hide() {
    ...
    planeDiscoveryView.stopAnimation();
  }
}
